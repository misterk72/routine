...
import com.healthtracker.ui.HealthTrackerViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerHealthTrackerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends HealthTrackerApp_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(HealthTrackerViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends HealthTrackerApp_HiltComponents.ViewModelC {
    ...
    private Provider<HealthTrackerViewModel> healthTrackerViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.healthTrackerViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, javax.inject.Provider<ViewModel>>singletonMap("com.healthtracker.ui.HealthTrackerViewModel", ((Provider) healthTrackerViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.healthtracker.ui.HealthTrackerViewModel 
          return (T) new HealthTrackerViewModel(singletonCImpl.provideHealthDatabaseProvider.get());
  ...
  private static final class SingletonCImpl extends HealthTrackerApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideHealthDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<HealthDatabase>(singletonCImpl, 0));
    }

    @Override
    public void injectHealthTrackerApp(HealthTrackerApp healthTrackerApp) {
      injectHealthTrackerApp2(healthTrackerApp);
    }
    ...
    private HealthTrackerApp injectHealthTrackerApp2(HealthTrackerApp instance) {
      HealthTrackerApp_MembersInjector.injectWorkerFactory(instance, hiltWorkerFactory());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.healthtracker.data.HealthDatabase 
          return (T) AppModule_ProvideHealthDatabaseFactory.provideHealthDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
